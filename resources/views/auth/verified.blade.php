...
<head>
    ...
    <title>Email Verified - Bank Syariah Indonesia - UAE</title>
</head>
                ...
                <div class="col-12">
                    <div class="position-relative mt-0 mt-sm-64 mb-32">
                        ...
                        <img class="position-relative d-block mx-auto"
                            src="{{asset('app-assets/img/email-verify.svg')}}" alt="Email Verified" width="150px">
                    </div>

                    <h2 class="h2 mb-0 mb-sm-16 font-weight-600">Email Telah Terverifikasi</h2>

                    <a href="{{ route('dashboard.index') }}" type="button" class="btn btn-primary">
                        Buka Dashboard
                    </a>
                </div>
            </div>
